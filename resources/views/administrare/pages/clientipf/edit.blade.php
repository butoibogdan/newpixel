        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <h1>Edit Clientipf</h1>
                    <hr/>

                    {!! Form::model($clientipf, ['method' => 'PATCH', 'action' => ['{!!Config::newpixel('controller_link')!!}ClientipfController@update', $clientipf->id], 'class' => 'form-horizontal']) !!}
