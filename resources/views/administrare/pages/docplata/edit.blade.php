        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <h1>Edit Docplatum</h1>
                    <hr/>

                    {!! Form::model($docplatum, ['method' => 'PATCH', 'action' => ['{!!Config::newpixel('controller_link')!!}DocplataController@update', $docplatum->id], 'class' => 'form-horizontal']) !!}
